...
const CoinHeader = () => {
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <button className="cursor-pointer w-[139px] h-[54px] rounded-[12px] bg-[#E44615] p-[18px] flex items-center justify-center text-[16px] font-archivo font-[500] leading-[1.15] text-white mb-5 lg:mb-6">
        Lanch a coin
      </button>
